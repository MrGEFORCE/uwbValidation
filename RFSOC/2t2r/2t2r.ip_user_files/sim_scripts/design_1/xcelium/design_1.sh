...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../2t2r.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../2t2r.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"../../../../2t2r.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../2t2r.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
