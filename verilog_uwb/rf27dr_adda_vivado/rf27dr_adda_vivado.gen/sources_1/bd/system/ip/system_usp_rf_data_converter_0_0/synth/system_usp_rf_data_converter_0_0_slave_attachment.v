//-----------------------------------------------------------------------------
// Filename:        system_usp_rf_data_converter_0_0_slave_attachment.v
// Version:         v1.00.a
...
//-----------------------------------------------------------------------------
`timescale 1 ps/1 ps
module system_usp_rf_data_converter_0_0_slave_attachment
#(
...
//-----------------------------------------------------------------------------
localparam C_INCLUDE_DPHASE_TIMER = C_DPHASE_TIMEOUT;
localparam AXI_RESP_OK  = 2'b00;
localparam AXI_RESP_SLVERR = 2'b10;
localparam[2:0] IDLE = 0; 
localparam[2:0] READING = 1; 
localparam[2:0] READ_WAIT = 2; 
localparam[2:0] WRITE_WAIT = 3; 
localparam[2:0] WRITING = 4; 
localparam[2:0] B_VALID = 5; 
localparam[2:0] BRESP_WAIT = 6; 
localparam COUNTER_WIDTH = clog2(C_DPHASE_TIMEOUT);
localparam [COUNTER_WIDTH-1:0] DPTO_LD_VALUE = C_DPHASE_TIMEOUT-1;
...
reg      axi_avalid; 
reg      axi_avalid_reg; 
reg[(C_IPIF_ABUS_WIDTH - 1):0] bus2ip_addr_i; 
reg      bus2ip_rnw_i; 
...
//-------------------------------------------------------------------------------
system_usp_rf_data_converter_0_0_address_decoder 
#(
...
.Address_In_Erly(bus2ip_addr_i[C_IPIF_ABUS_WIDTH-1:0]),
...
system_usp_rf_data_converter_0_0_counter_f 
#(
