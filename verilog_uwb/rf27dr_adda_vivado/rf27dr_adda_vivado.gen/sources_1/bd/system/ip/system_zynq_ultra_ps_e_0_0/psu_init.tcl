...
set psu_ddr_init_data {
    ...
    mask_write 0XFD0700DC 0xFFFFFFFF 0x09400301
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x048E8209
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000C07
    ...
    mask_write 0XFD070240 0x0F1F0F7C 0x06000614
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x08261209
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00371209
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00000C12
    ...
    mask_write 0XFD080180 0xFFFFFFFF 0x00000840
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180080 0x000000FE 0x00000080
    ...
    mask_write 0XFF180090 0x000000FE 0x00000080
    ...
    mask_write 0XFF180094 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800A0 0x000000FE 0x00000040
    ...
    mask_write 0XFF1800A4 0x000000FE 0x00000040
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B02400
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x000E0044 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
    ...
    mask_write 0XFF0A0204 0x03FFFFFF 0x02000000
		# : DIR MODE BANK 1
		# : DIR MODE BANK 2
		# : OUTPUT ENABLE BANK 0
		# Register : OEN_0 @ 0XFF0A0208</p>
    ...
    mask_write 0XFF0A0004 0x03FF03FF 0x01FF0200
    ...
    mask_write 0XFF0A0004 0x03FF03FF 0x01FF0000
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00040000
		# : DIR MODE BANK 2
		# : OUTPUT ENABLE BANK 0
		# : OUTPUT ENABLE BANK 1
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00040000
		# : OUTPUT ENABLE BANK 2
		# : MASK_DATA_0_LSW LOW BANK [15:0]
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# Register : MASK_DATA_1_MSW @ 0XFF0A000C</p>
    ...
    mask_write 0XFF0A000C 0x03FF03FF 0x03FB0004
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 1US DELAY
    mask_delay 0x00000000 1
    ...
    mask_write 0XFF0A000C 0x03FF03FF 0x03FB0000
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5US DELAY
    mask_delay 0x00000000 5
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410004 0x0000001F 0x0000000D
    ...
    mask_write 0XFD410008 0x0000001F 0x0000000C
    ...
    mask_write 0XFD4010CC 0x00000020 0x00000020
		# Register : L1_TM_AUX_0 @ 0XFD4050CC</p>
    ...
    mask_write 0XFD4050CC 0x00000020 0x00000020
    ...
    mask_write 0XFD4058F8 0x000000FF 0x00000064
    ...
    mask_write 0XFD4058FC 0x000000FF 0x00000064
    ...
    mask_write 0XFD405990 0x000000FF 0x00000011
    ...
    mask_write 0XFD405924 0x000000FF 0x00000004
    ...
    mask_write 0XFD405928 0x000000FF 0x000000FE
    ...
    mask_write 0XFD405900 0x000000FF 0x00000064
    ...
    mask_write 0XFD40592C 0x000000FF 0x00000000
    ...
    mask_write 0XFD4098F8 0x000000FF 0x00000034
    ...
    mask_write 0XFD4098FC 0x000000FF 0x00000034
    ...
    mask_write 0XFD409900 0x000000FF 0x00000034
    ...
    mask_write 0XFD410010 0x00000077 0x00000011
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD480184 0x00000FFF 0x00000082
    ...
    mask_write 0XFD480200 0xFFFFFFFF 0x10EED022
    ...
    mask_write 0XFD48013C 0x00000020 0x00000000
